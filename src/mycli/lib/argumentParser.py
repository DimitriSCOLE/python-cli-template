...
class MyArgumentParser(ArgumentParser):
        ...
        def format_help(self):
                ...
                #Add mycli command help (not managed by argparse but by python cmd2)
                formatter.start_section("commands")
                formatter.add_text("Available mycli commands")
                formatter.add_arguments(self.mycli_actions)
                formatter.end_section()
